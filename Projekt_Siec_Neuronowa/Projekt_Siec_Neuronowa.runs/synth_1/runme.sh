...
HD_PWD='C:/Projektvivado/Projekt_Siec_Neuronowa/Projekt_Siec_Neuronowa.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Siec_Neuronowa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Siec_Neuronowa.tcl
